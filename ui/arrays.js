...
const addData= () =>{
     ...
     name=document.getElementById("adname");
     email=document.getElementById("admail");
    ...
    emps.push({id:id.value,name:id.name,email:id.email,organaization:id.org});

    empTable(rows);
    localStorage.setItem("emps",JSON.stringify(emps));
    localStorage.setItem("emps",JSON.stringify());
